...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      $message[] = 'already added to Marked!';
   }else{
      ...
      $message[] = 'Hostel added to marked!';
   }
...
<div class="heading">
   <h3>our PG</h3>
   <p> <a href="home.php">home</a> / PG's </p>
</div>

<section class="products">

   <h1 class="title">latest PG's</h1>
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <?php
         ...
         echo '<p class="empty">no hostels added yet!</p>';
      }
      ?>
   </div>
